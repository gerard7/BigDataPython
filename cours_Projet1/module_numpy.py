...
#     - Calcul Scientifique et Ingenierie avancée
...
random_array = np.random.randint(0,100,(3,3)) # Génère une matrice de nombres aléatoires de 0 à 100.
...
n=10.3
print(f"Division par le scalaire {n}:", array/10)

# Transformation e, Matrix 2D
matrix = array.reshape(1,5)  # Cela transforme le tableau simple (vecteur) en Matrice 2D : 1 Ligne , 5 Colonne
print("Reshape en Matrice = ",matrix)  #
...
# print("Ne peut pas faire de v (2,3)  dont de 6 éléments , en une reshape en matrice (3,3) car celle-ci fait 9 éléments",ne_peut_pas)
...
# nanmean(matrix , axis=1, np.where, ...) où les endroits Nan seront remplacés par la moyenne des colonne ou celle des lignes
